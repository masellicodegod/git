// Much of this code is stolen and thanks to the help of Mr. Cozart and https://stackoverflow.com/questions/19921248/how-to-center-canvas-javascript
//######### setup the canvas
...
function cupGen() {
    ...
    var cup2 = new Cup(cupImage, 32, 32, 195, 100, 0, "boss");
    var cup3 = new Cup(cupImage, 32, 32, 255, 100, 0, "boss");
    var cup4 = new Cup(cupImage, 32, 32, 317, 100, 0, "boss");
    var cup5 = new Cup(cupImage, 32, 32, 280, 150, 0, "boss");
    var cup6 = new Cup(cupImage, 32, 32, 220, 150, 0, "boss");
    var cup7 = new Cup(cupImage, 32, 32, 157, 150, 0, "boss");
    var cup8 = new Cup(cupImage, 32, 32, 250, 200, 0, "boss");
    var cup9 = new Cup(cupImage, 32, 32, 190, 200, 0, "boss");
    var cup10 = new Cup(cupImage, 32, 32, 217, 250, 0, "boss");
...
function update() {
    ...
    for (cup in allCups) {
        if (
            ...
            console.log("Our code finally worked!?!");
            ball.reset();
